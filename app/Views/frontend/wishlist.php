                            ...
                            <div class="wishlist-all-pro">
                                <div class="wishlist-pro">
                                    <div class="wishlist-pro-image">
                                        <a href="product.html"><img src="<?= base_url()?>public/assets/image/cart-page/cart-1/image1.jpg" class="img-fluid" alt="image"></a>
                                    </div>
                                ...
                                <div class="all-pro-price">
                                    <span class="new-price">$384.51 USD</span>
                    ...
                    <div class="wishlist-area">
                        <div class="wishlist-details">
                            <div class="wishlist-all-pro">
                                <div class="wishlist-pro">
                                    <div class="wishlist-pro-image">
                                        <a href="product.html"><img src="<?= base_url()?>public/assets/image/cart-page/cart-1/image3.jpg" class="img-fluid" alt="image"></a>
                                    </div>
                                    <div class="pro-details">
                                ...
                                <div class="all-pro-price">
                                    <span class="new-price">$460.00 USD</span>
                    ...
                    <div class="wishlist-area">
                        <div class="wishlist-details">
                            <div class="wishlist-all-pro">
                                <div class="wishlist-pro">
                                    <div class="wishlist-pro-image">
                                        <a href="product.html"><img src="<?= base_url()?>public/assets/image/cart-page/cart-1/image2.jpg" class="img-fluid" alt="image"></a>
                                    </div>
                                    <div class="pro-details">
                                ...
                                <div class="all-pro-price">
                                    <span class="new-price">$109.20 USD</span>
                                    <span class="old-price"><del>$99.99 USD</del></span>
                                </div>
                            </div>
                            <div class="other-link">
                                <ul class="c-link">
                                    <li class="wishlist-other-link"><a href="grid-list.html" class="btn-style1">Continue shopping</a></li>
