                    ...
                    <div class="all-filter">
                        ...
                        <div class="filter-banner">
                            <a href="grid-list.html" class="grid-banner">
                                <img src="<?= base_url()?>public/assets/image/grid-banner.jpg" class="img-fluid" alt="image">
                            </a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-9 col-md-8 col-12">
                    <div class="grid-list-banner" style="background-image: url(<?= base_url()?>public/assets/image/slider17.jpg);">
