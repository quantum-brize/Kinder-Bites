                        ...
                        <div class="footer-content-area">
                            <ul class="footer-ul">
                                <li class="footer-li logo-info">
                                    ...
                                    <div class="desc">
                                        <p>Welcome to Kinder Bites, where passion meets nutrition! We offer wholesome snacks for all ages, revolutionizing snacking with tasty, nourishing treats.</p>
                                    </div>
                                    <div class="payment">
                                        <span>
                                ...
                                <li class="footer-li store-info">
                                    ...
                                    <ul class="f-link-ul">
                                        <li class="f-link-ul-li">
                                            ...
                                            <div class="text">
                                                <a href="mailto:info@skinderbites.com">info@kinderbites.com </a>
                                            </div>
                                        </li>
                                        <li class="f-link-ul-li">
                                            <div class="icon">
                                            ...
                                            <div class="text">
                                                <a href="tel:+919152000101">+91 9152000101</a>
                                            </div>
                                        </li>
                                    </ul>
                                </li>
                    ...
                    <div class="col">
                        <ul class="copyrighta-ul">
                            <li class="copyrighta-li">
                                <span class="copy-text">© 2024 Kinder Bites Developed by <a target="_blank" href="https://quantumbrize.com">Quantum Brize</a></span>
                            </li>
                            <li class="copyrighta-li social">
                                <ul class="social-ul">
                                    <li class="social-li">
